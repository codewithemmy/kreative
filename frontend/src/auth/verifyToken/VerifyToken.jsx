...
import image from "../../assets/authScreens/Mask Group 1.png";
import loading from "../../assets/Cityfix-Logo-Green-Gif2.gif";
import logo from "../../assets/Cityfix-Logo-Green-Gif2.gif";
        ...
        <div className=" w-full sm:w-4/5 lg:w-1/2 flex justify-center items-center p-8">
          <div className="w-full h-full p-4 lg:py-3 lg:pl-6 lg:pr-10">
            <div className="w-full mb-6 p-2">
              ...
              <div className="text-h2 text-sm font-thin text-center w-full">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div
                style={{ fontSize: "10px" }}
                className="w-full flex items-center justify-center gap-x-3 mt-4"
              >
                <p className="text-left w-full p-2">
