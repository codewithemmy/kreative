          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-2 gap-20">
              ...
              <div className="flex flex-col justify-center h-screen">
                ...
                <div>
                  <form action="" className="">
                    <input
                      type="email"
                      className="w-full my-3 rounded-full px-5 py-3 bg-transparent border border-gray-300 outline-none focus:border-blue-800"
                      placeholder="Email"
                    />
                    <button className="bg-blue-800 rounded-full px-8 py-3 flex justify-center text-white font-semibold mx-auto my-3">
                      Recover Password
                    </button>
                  </form>
                </div>
            ...
            <div className="col-span-1 bg-blue-900 h-screen">
              <div className="flex flex-col lg:flex-row xl:flex-row 2xl:flex-row justify-center items-center h-screen">
                <div>
                  <img
                    src="../../assets/Forgot password1.gif"
                    alt="signup page"
                    width="400px"
                  />
                </div>
